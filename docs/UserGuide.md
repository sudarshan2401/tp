...
Starts a lesson in your chosen class. <br>
This increases the total number of lessons conducted in your class and automatically marks all students absent.
...
- If a `Student`'s number of lessons attended <u>exceeds</u> the NUMBER_OF_LESSONS, it is automatically reduced to NUMBER_OF_LESSONS.
    - Example: John's current attendance in CS2103T is 5/7. <br> If you enter `setlesson /c CS2103T /l 3`, it will adjust John's attendance to 3/3.
...
* The class which you intend to add the student into, must already exist.
