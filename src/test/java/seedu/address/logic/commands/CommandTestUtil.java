...
public class CommandTestUtil {
    ...
    public static final String VALID_CLASSINDEX = "1";
    public static final String VALID_CLASSNAME = "CS2105";
    ...
    public static final String CLASSINDEX_DESC_BOB = " " + PREFIX_CLASS + VALID_CLASSINDEX;
    public static final String CLASSINDEX_DESC_AMY = " " + PREFIX_CLASS + VALID_CLASSINDEX;
