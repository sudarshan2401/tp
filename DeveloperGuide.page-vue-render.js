...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses a class out of all the classes they are teaching.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to view all the information about that class.")])]),_v(" "),_c('li',[_c('p',[_v("EduTrack displays all the information about that class. (e.g. name, students, attendance, notes, etc)")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Wed, 27 Sept 2023, 17:58:08 GMT+8]")])])])}
}];
